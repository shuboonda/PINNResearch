...
predicted_solution_u = predicted_solution[:, 1].reshape(test_x.shape)
...
# Plot the gradients and second-order gradients
fig, axs = plt.subplots(3, 3, figsize=(18, 16))
im = axs[0, 0].contourf(test_x, test_y, u_x, cmap="jet", levels=100)
fig.colorbar(im, ax=axs[0, 0])
axs[0, 0].set_title("u_x")
axs[0, 0].set_xlabel("x")
axs[0, 0].set_ylabel("y")

im = axs[0, 1].contourf(test_x, test_y, u_y, cmap="jet", levels=100)
fig.colorbar(im, ax=axs[0, 1])
axs[0, 1].set_title("u_y")
axs[0, 1].set_xlabel("x")
axs[0, 1].set_ylabel("y")

im = axs[0, 2].contourf(test_x, test_y, v_x, cmap="jet", levels=100)
fig.colorbar(im, ax=axs[0, 2])
axs[0, 2].set_title("v_x")
axs[0, 2].set_xlabel("x")
axs[0, 2].set_ylabel("y")

im = axs[1, 0].contourf(test_x, test_y, v_y, cmap="jet", levels=100)
fig.colorbar(im, ax=axs[1, 0])
axs[1, 0].set_title("v_y")
axs[1, 0].set_xlabel("x")
axs[1, 0].set_ylabel("y")

im = axs[1, 1].contourf(test_x, test_y, u_xx, cmap="jet", levels=100)
fig.colorbar(im, ax=axs[1, 1])
axs[1, 1].set_title("u_xx")
axs[1, 1].set_xlabel("x")
axs[1, 1].set_ylabel("y")

im = axs[1, 2].contourf(test_x, test_y, u_yy, cmap="jet", levels=100)
fig.colorbar(im, ax=axs[1, 2])
axs[1, 2].set_title("u_yy")
axs[1, 2].set_xlabel("x")
axs[1, 2].set_ylabel("y")

im = axs[2, 0].contourf(test_x, test_y, v_xx, cmap="jet", levels=100)
fig.colorbar(im, ax=axs[2, 0])
axs[2, 0].set_title("v_xx")
axs[2, 0].set_xlabel("x")
axs[2, 0].set_ylabel("y")

im = axs[2, 1].contourf(test_x, test_y, v_yy, cmap="jet", levels=100)
fig.colorbar(im, ax=axs[2, 1])
axs[2, 1].set_title("v_yy")
