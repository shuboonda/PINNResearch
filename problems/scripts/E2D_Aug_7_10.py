...
SAMPLE_POINTS = 2000
WIDTH = LENGTH = 10.0  # Update dimensions to 10x10
...
# Define geometry
geom = dde.geometry.Rectangle([0, 0], [10, 10])  # 10x10 plate centered at (5, 5)
...
x = np.linspace(0, 10, nelx + 1)  # x coordinates updated for 10x10 object
y = np.linspace(0, 10, nely + 1)  # y coordinates updated for 10x10 object
...
df.to_csv('predicted_new_terms.csv', index=False)
